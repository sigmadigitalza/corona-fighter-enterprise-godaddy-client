...
func (r ApiDomainsForwardsDeleteRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *V2ApiService) DomainsForwardsDeleteExecute(r ApiDomainsForwardsDeleteRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiDomainsForwardsGetRequest) Execute() ([]DomainForwarding, *_nethttp.Response, error) {
 ...
 */
func (a *V2ApiService) DomainsForwardsGetExecute(r ApiDomainsForwardsGetRequest) ([]DomainForwarding, *_nethttp.Response, error) {
	var (
...
func (r ApiDomainsForwardsPutRequest) Execute() (*_nethttp.Response, error) {
 ...
 * Execute executes the request
 */
func (a *V2ApiService) DomainsForwardsPutExecute(r ApiDomainsForwardsPutRequest) (*_nethttp.Response, error) {
	var (
